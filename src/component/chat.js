...
import '../index.css';
import GolIcon from '../img/gol_transparente.svg';
        ...
        <MDBCard className='chat-container'>
            <MDBCardTitle className='chat-title'>
                <div className='card-title-div'>
                    { !isMobile ?
                        <h1 className='chat-title-desktop'>GOL PLACAS ABC - ASSISTENTE VIRTUAL</h1>
                        :
                        <h1 className='chat-title-mobile'><span className='title'>GOL PLACAS ABC - ASSISTENTE VIRTUAL</span><span className='icon' onClick={() => setView('home')}><AiOutlineClose /></span></h1>
                    }
                </div>
            </MDBCardTitle>
            <MDBCardBody className='card-chat'>
                        ...
                        <div className={`message-container ${msg.type === 'user' ? 'user' : 'bot'}`}>
                            {msg.type !== 'user' &&
                                <span className={`icon-container ${msg.type === 'user' ? 'user' : 'bot'}`}>
                                    <img src={GolIcon} className={`icon-message ${msg.type === 'user' ? 'user' : 'bot'}`} alt='Icone da empresa' />
                                </span>
                            }
                ...
                {isTyping && <div className='message-container bot'>
                    <span className='icon-container bot'>
                        <img src={GolIcon} className='icon-message bot' alt='Icone da empresa' />
                    </span>
